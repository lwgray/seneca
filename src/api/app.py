...
# Import API blueprints that work
...
# Temporarily commented out problematic imports to test basic functionality
...
# Register blueprints - only the ones that work for now
app.register_blueprint(project_api)
app.register_blueprint(prediction_api)
app.register_blueprint(analytics_api)

# Temporarily commented out problematic blueprints
...
# Import conversation websocket handler - commented out for testing
# from src.api.conversation_websocket import setup_conversation_websocket_handlers

# Setup WebSocket handlers - commented out for testing
...
def run_server(host="0.0.0.0", port=5000, debug=False):  # nosec B104
    """Run the API server."""
    # Start background task for WebSocket updates - commented out for testing
    # socketio.start_background_task(emit_updates_task)
    
    # Start conversation streaming in background - commented out for testing
